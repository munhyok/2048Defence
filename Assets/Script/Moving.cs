...
public class Moving : MonoBehaviour
{
    ...
    public void Move(int x2, int y2, bool combine)
    {
        ...
        transform.position = Vector3.MoveTowards(transform.position, new Vector3(0.9f * x2 - 1.35f, 0.9f * y2 - 1.35f, 0), 0.3f);
        if (transform.position == new Vector3(0.9f * x2 - 1.35f, 0.9f * y2 - 1.35f, 0))
        {
            move = false;
